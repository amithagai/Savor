...
export default function Footer() {
  ...
  return (
    <>
      <footer className="footer">
        <div className="footer__inner">
          ...
          <div className="footer__col">
            <p className="footer__col-title">{content?.content_title || 'תוכן והדרכה'}</p>
            <ul>
          ...
          {/* שירות לקוחות */}
          <div className="footer__col">
            <p className="footer__col-title">{content?.service_title || 'שירות לקוחות'}</p>
            <ul>
          ...
          <div>
            <div className="footer__social-row">
              <p className="footer__social-title">{content?.contact_title || 'דברו איתנו'}</p>
              <div className="footer__social-icons">
                <a href={content?.instagram_url || '#'} className="footer__social-link" aria-label="Instagram">
                  <img src={instagramIcon} alt="" />
                </a>
                <a href={content?.whatsapp_url || 'https://wa.me/972509072335'} className="footer__social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
      ...
      {isHomeScreen && ( 
      <a href={content?.whatsapp_url || 'https://wa.me/972509072335'} className="whatsapp-fab" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
